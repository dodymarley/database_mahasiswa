...
MySQL - 10.1.31-MariaDB : Database - dodibsi22
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dodibsi22` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `jadwal mengajar dosen` (
  `Nama dosen` varchar(5) NOT NULL,
  `Kode dosen` varchar(100) DEFAULT NULL,
  `Hari` char(10) DEFAULT NULL,
  `Jadwal mengajar` time(5) DEFAULT NULL,
  `Kelas` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`Nama dosen`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
